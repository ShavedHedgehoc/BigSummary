...
let TraceAuthorOccupation = class TraceAuthorOccupation extends sequelize_typescript_1.Model {
};
__decorate([
    sequelize_typescript_1.PrimaryKey,
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], TraceAuthorOccupation.prototype, "AuthorOccupationsPK", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => trace_author_model_1.default),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], TraceAuthorOccupation.prototype, "AuthorPK", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => trace_plant_model_1.default),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], TraceAuthorOccupation.prototype, "PlantPK", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => trace_author_model_1.default),
    __metadata("design:type", trace_author_model_1.default)
], TraceAuthorOccupation.prototype, "author", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => trace_plant_model_1.default),
    __metadata("design:type", trace_plant_model_1.default)
], TraceAuthorOccupation.prototype, "plant", void 0);
TraceAuthorOccupation = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "AuthorOccupations" })
], TraceAuthorOccupation);
exports.default = TraceAuthorOccupation;
//# sourceMappingURL=tarce_author_occupation.model.js.map