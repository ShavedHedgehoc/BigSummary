...
let TraceBoil = class TraceBoil extends sequelize_typescript_1.Model {
};
__decorate([
    sequelize_typescript_1.PrimaryKey,
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], TraceBoil.prototype, "BoilPK", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => trace_batch_model_1.default),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], TraceBoil.prototype, "BatchPK", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => trace_product_model_1.default),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], TraceBoil.prototype, "ProductId", void 0);
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], TraceBoil.prototype, "Quantity", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => trace_batch_model_1.default),
    __metadata("design:type", trace_batch_model_1.default)
], TraceBoil.prototype, "batch", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => trace_product_model_1.default),
    __metadata("design:type", trace_product_model_1.default)
], TraceBoil.prototype, "product", void 0);
TraceBoil = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "Boils" })
], TraceBoil);
exports.default = TraceBoil;
//# sourceMappingURL=trace_boils.model.js.map