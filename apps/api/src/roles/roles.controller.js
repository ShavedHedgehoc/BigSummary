...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, type: roles_model_1.default }),
    (0, common_1.Post)(),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: roles_model_1.default }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Получить все роли" }),
    (0, swagger_1.ApiResponse)({ status: 200, type: [roles_model_1.default] }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
