...
import { BoilsService } from "src/v1/boils/boils.service";
import { ApparatusesService } from "src/v1/apparatuses/apparatuses.service";
import { CansService } from "src/v1/cans/cans.service";
import { ConveyorsService } from "src/v1/conveyors/conveyors.service";
import { WorkshopsService } from "src/v1/workshops/workshops.service";
import Doc from "src/v1/docs/docs.model";
...
import { PlantsService } from "src/v1/plants/plants.service";
import Apparatus from "src/v1/apparatuses/apparatuses.model";
import Can from "src/v1/cans/cans.model";
import Conveyor from "src/v1/conveyors/conveyor.model";
import Workshop from "src/v1/workshops/workshop.model";
import Plant from "src/v1/plants/plant.model";
import { GetCurrentDocDto } from "src/v1/doc.detail/dto/get-current-doc.dto";
...
import { MarkingSampleService } from "src/v1/marking_sample/marking_sample.service";
import { RecordRegulationsService } from "src/v1/record_regulations/record_regulations.service";
import { CreateRecordRegulationDto } from "src/v1/record_regulations/dto/create-record-regulation.dto";
import { parseSemiproducts } from "src/v1/helpers/parse-semiproducts";
import { SemiProductsService } from "src/v1/semi_products/semi_products.service";
import { CreateSemiProductDto } from "src/v1/semi_products/dto/create-semi-product.dto";
