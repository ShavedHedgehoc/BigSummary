...
import User from "src/v1/users/users.model";
import Employee from "src/v1/employees/employees.model";
import { AddHistoryDtoNew } from "./dto/add-histories.dto";
import { HistoryTypesService } from "src/v1/history_types/history_types.service";
import { RecordsService } from "src/v1/records/records.service";
import { UsersService } from "src/v1/users/users.service";
import { BoilsService } from "src/v1/boils/boils.service";
import HistoryType from "src/v1/history_types/history_types.model";
// import { DbRoles } from "src/resources/dbRoles";
import { EmployeesService } from "src/v1/employees/employees.service";
import { ProductsService } from "src/v1/products/products.service";
import { BasesService } from "src/v1/bases/bases.service";
import { NotesService } from "src/v1/notes/notes.service";
import { ApiMessages } from "src/v1/resources/api-messages";
import { ApiErrorsService } from "src/v1/api_errors/api_errors.service";
import Note from "src/v1/notes/notes.model";
