...
export default function AppSummaryCard(item: TRecordDetailResponse) {
  return <div>{item.apparatus}</div>;
  ...
  //     <div
  //       className={`font-ultralight text-lg  pl-3  ${item.stateValue === 'base_check' ||
  //           item.stateValue === 'base_correct' ||
  //           item.stateValue === 'base_continue'
  //           ? 'text-yellow-500'
  //           : item.stateValue === 'base_fail'
  ...
  //     </div>
  //     <div
  //       className={`font-semibold text-xl  pl-3  pt-1 pb-2 ${item.stateValue === 'base_check' ||
  //           item.stateValue === 'base_correct' ||
  //           item.stateValue === 'base_continue'
  //           ? 'text-yellow-500'
  //           : item.stateValue === 'base_fail'
  ...
  //     <div
  //       className={`${item.stateValue === 'product_check' ||
  ...
  //     </div>
  //     <div
  //       className={`${item.stateValue === 'product_check' || item.stateValue === 'product_correct'
