...
import classes from "./technologist.module.css";
...
import TechnologistTable from "../../tables/TechnologistTable";
  ...
  return (
    <SinglePageWrapper errorElement={<Message visible={msgVisible} severity={msgSeverity} message={msgText} />}>
      <div className={classes.laboratory_page__container}>
        <div className={classes.laboratory_page__header}>Главный технолог</div>
