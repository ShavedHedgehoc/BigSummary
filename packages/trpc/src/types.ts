...
export interface IWorkstationEmployeeService {
    getEmployeeByBarcode: (input: TGetWorkstationEmployeeByBarcodeInput) => Promise<TWorkstationEmployeeByBarcodeOutput | null>
}

export interface IWorkstationConveyorService {
    getConveyorByBarcode: (input: TGetWorkstationConveyorByBarcodeInput) => Promise<TWorkstationConveyorByBarcodeOutput | null>
}
